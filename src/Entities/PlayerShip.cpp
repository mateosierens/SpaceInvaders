...
const std::shared_ptr<Controllers::BulletController>& PlayerShip::getBullet() const { return bullet; }
...
void PlayerShip::removeEnemyBullet(const int& index) { enemyBullets.erase(enemyBullets.begin() + index); }

int PlayerShip::getLives() const { return lives; }
...
bool PlayerShip::isAlive() const { return alive; }

void PlayerShip::kill() { alive = false; }
} // namespace Entities
